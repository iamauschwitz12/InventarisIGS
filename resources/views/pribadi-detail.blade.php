...
<head>
    ...
    <title>Detail Inventaris - {{ $record->nama_barang }}</title>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-t-2xl shadow-xl p-6 md:p-8">
            <div class="flex items-center mb-4">
                <svg class="w-8 h-8 md:w-10 md:h-10 text-purple-600 mr-3" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Inventaris Pribadi</h1>
                    <p class="text-sm text-gray-500">Detail Barang Inventaris</p>
                </div>
            </div>

            <div class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white p-4 md:p-6 rounded-xl mt-4">
                <h2 class="text-xl md:text-2xl font-bold mb-2">{{ $record->nama_barang }}</h2>
                <p class="text-purple-100 text-sm md:text-base flex items-center">
            ...
            <div class="p-6 md:p-8 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <dd class="text-base md:text-lg font-bold text-purple-600">{{ $record->jumlah ?? '-' }}</dd>
                    </div>
                </div>
            </div>
            ...
            @if ($record->img || $record->qrcode)
                <div class="p-6 md:p-8 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @if ($record->img)
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h4 class="text-sm font-medium text-gray-600 mb-3">Gambar Barang</h4>
                        ...
                        @if ($record->qrcode)
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h4 class="text-sm font-medium text-gray-600 mb-3">QR Code</h4>
                                <div class="flex justify-center">
                                    <img src="{{ asset('storage/' . $record->qrcode) }}"
                                        alt="QR Code {{ $record->kode_inventaris }}" class="rounded-lg shadow-lg max-w-[200px]">
                                </div>
                            </div>
                        @endif
                    </div>
