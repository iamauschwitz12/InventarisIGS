<div class="space-y-6">
    <!-- Header Info -->
    <div class="bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-6 rounded-lg shadow-lg">
        <h2 class="text-xl font-bold">{{ $record->nama_barang }}</h2>
        <p class="text-emerald-100 text-sm mt-1">{{ $record->kode_inventaris ?? '-' }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                ...
                <dl class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm font-bold text-emerald-600">{{ $record->jumlah ?? '-' }}</dd>
                    </div>
                </dl>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                ...
                <dl class="space-y-3">
                    <div class="flex justify-between">
                        <dt class="text-sm text-gray-500 dark:text-gray-400">Tipe Aset</dt>
                        <dd class="text-sm font-medium text-gray-900 dark:text-white">
