...
<head>
    ...
    <title>Detail Inventaris Dana BOS - {{ $record->nama_barang }}</title>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-t-2xl shadow-xl p-6 md:p-8">
            <div class="flex items-center mb-4">
                <svg class="w-8 h-8 md:w-10 md:h-10 text-blue-600 mr-3" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Inventaris Dana BOS</h1>
                    <p class="text-sm text-gray-500">Detail Barang Inventaris</p>
                </div>
            </div>

            <div class="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-4 md:p-6 rounded-xl mt-4">
        ...
        <div class="bg-white shadow-xl">
            ...
            <div class="p-6 md:p-8 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <dd class="text-base md:text-lg font-bold text-blue-600">{{ $jumlahTotal ?? $record->jumlah ?? '-' }}</dd>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 md:p-8 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-indigo-50 p-4 rounded-lg">
                        ...
                        <dd class="text-base md:text-lg font-semibold text-gray-900">
                            {{ $record->tipeAset->tipe_aset ?? '-' }}</dd>
                    </div>
                    <div class="bg-indigo-50 p-4 rounded-lg">
                        <dt class="text-sm font-medium text-gray-500 mb-1">Kategori</dt>
                        <dd class="text-base md:text-lg font-semibold text-gray-900">
                            {{ $record->tipeAsetKategori->nama_tipe_kategori ?? '-' }}</dd>
                    </div>
                    <div class="bg-indigo-50 p-4 rounded-lg">
                        <dt class="text-sm font-medium text-gray-500 mb-1">Tipe Aset Dana BOS</dt>
                        <dd class="text-base md:text-lg font-semibold text-gray-900">
            ...
            @if ($record->img)
                @php
                    ...
                    } elseif (\Illuminate\Support\Facades\Storage::disk('public')->exists('danabos-images/' . $imgPath)) {
                        $imgUrl = asset('storage/danabos-images/' . $imgPath);
                    } else {
                        $imgUrl = asset('storage/' . $imgPath);
                    }
                @endphp
                <div class="p-6 md:p-8 border-b border-gray-200">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex justify-center">
                            <img src="{{ $imgUrl }}" alt="{{ $record->nama_barang }}"
        ...
        <div class="bg-gray-100 rounded-b-2xl shadow-xl p-4 md:p-6">
            ...
            <div class="text-center mt-4 text-sm text-gray-600">
                <p>Sistem Informasi Inventaris Dana BOS</p>
            </div>
        </div>
    </div>
</body>
